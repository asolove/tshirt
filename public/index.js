...
(function(exports) {
  ...
  var showTextAlign = new Prelude.Show(function (_7) {
      ...
      throw new Error("Failed pattern match at Graphics.Canvas line 382, column 1 - line 389, column 1: " + [ _7.constructor.name ]);
  });
  var showComposite = new Prelude.Show(function (_6) {
      ...
      throw new Error("Failed pattern match at Graphics.Canvas line 222, column 1 - line 235, column 1: " + [ _6.constructor.name ]);
  });
  ...
  var setLineCap = function (_5) {
      ...
      throw new Error("Failed pattern match at Graphics.Canvas line 203, column 1 - line 204, column 1: " + [ _5.constructor.name ]);
  };
...
(function(exports) {
  ...
  var width = 500.0;
  var height = 250.0;
  var foldrN = function (__dict_Foldable_0) {
      return function (n) {
          return function (f) {
              return function (c) {
                  return function (u) {
                      return function (xs) {
                          var step = function (x) {
                              return function (_8) {
                                  if (Data_Array.length(_8.value0) === n - 1) {
                                      return new Data_Tuple.Tuple([  ], c(f(Data_Array.cons(x)(_8.value0)))(_8.value1));
                                  };
                                  if (Prelude.otherwise) {
                                      return new Data_Tuple.Tuple(Data_Array.cons(x)(_8.value0), _8.value1);
                                  };
                                  throw new Error("Failed pattern match at Main line 55, column 9 - line 56, column 9: " + [ x.constructor.name, _8.constructor.name ]);
                              };
                          };
                          var start = new Data_Tuple.Tuple([  ], u);
                          return Data_Tuple.snd(Data_Foldable.foldr(__dict_Foldable_0)(step)(start)(xs));
                      };
                  };
              };
          };
  ...
  var foldPixels = function (__dict_Foldable_1) {
      return foldrN(__dict_Foldable_1)(4);
  };
  var lastPixel = function (pixels) {
      return foldPixels(Data_Foldable.foldableArray)(Prelude.id(Prelude.categoryFn))(function (a) {
          return function (b) {
              return a;
          };
      })([  ])(pixels);
  ...
  var drawImageData = function (imageData) {
      return function (canvas) {
          return function __do() {
              ...
              Graphics_Canvas.setCanvasWidth(Data_Int.toNumber(imageData.width))(canvas)();
              Graphics_Canvas.setCanvasHeight(Data_Int.toNumber(imageData.height))(canvas)();
              return Graphics_Canvas.putImageData(_5)(imageData)(0.0)(0.0)();
          };
      };
  };
  var countWhitePixels = function (pixels) {
      var isWhite = function (_7) {
          if (_7.length === 4) {
              var _15 = _7[0] + _7[1] + _7[2] > 254.0 * 3.0;
              if (_15) {
                  return 1;
              };
              if (!_15) {
              ...
              throw new Error("Failed pattern match at Main line 34, column 9 - line 36, column 1: " + [ _15.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main line 34, column 9 - line 36, column 1: " + [ _7.constructor.name ]);
      };
      return foldPixels(Data_Foldable.foldableArray)(isWhite)(Prelude["+"](Prelude.semiringInt))(0)(pixels);
  };
  var countPixels = function (pixels) {
      var single = function (_6) {
          return 1;
      };
      return foldPixels(Data_Foldable.foldableArray)(single)(Prelude["+"](Prelude.semiringInt))(0)(pixels);
  };
  var centerY = 200.0;
  var centerX = 250.0;
  ...
  var main = function __do() {
      ...
      var _3 = Graphics_Canvas.getContext2D(Data_Maybe_Unsafe.fromJust(_4))();
      var _2 = Graphics_Canvas_Free.runGraphics(_3)(Prelude.bind(Control_Monad_Free.bindFree(Data_Coyoneda.functorCoyoneda))(Graphics_Canvas_Free.setFillStyle("#999999"))(function () {
          return Prelude.bind(Control_Monad_Free.bindFree(Data_Coyoneda.functorCoyoneda))(Graphics_Canvas_Free.rect({
              ...
              return Prelude.bind(Control_Monad_Free.bindFree(Data_Coyoneda.functorCoyoneda))(Graphics_Canvas_Free.fill)(function () {
                  return Prelude.bind(Control_Monad_Free.bindFree(Data_Coyoneda.functorCoyoneda))(Graphics_Canvas_Free.setStrokeStyle("#FFFFFF"))(function () {
                      return Prelude.bind(Control_Monad_Free.bindFree(Data_Coyoneda.functorCoyoneda))(Data_Foldable.traverse_(Control_Monad_Free.applicativeFree(Data_Coyoneda.functorCoyoneda))(Data_Foldable.foldableArray)(arcAboveRobot)(Prelude.map(Prelude.functorArray)(Prelude[">>>"](Prelude.semigroupoidFn)(function (_0) {
                          return _0 * 20 | 0;
                      })(Data_Int.toNumber))(Data_Array[".."](1)(20))))(function () {
                          return Graphics_Canvas_Free.getImageData(20.0)(20.0)(30.0)(30.0);
                      });
                  });
              });
          });
      }))();
      Control_Monad_Eff_Console_Unsafe.logAny(countWhitePixels(Data_ArrayBuffer_Typed.toArray(_2.data)))();
      Control_Monad_Eff_Console_Unsafe.logAny(lastPixel(Data_ArrayBuffer_Typed.toArray(_2.data)))();
      var _1 = Graphics_Canvas.getCanvasElementById("partial")();
      return drawImageData(_2)(Data_Maybe_Unsafe.fromJust(_1))();
  };
  exports["arcAboveRobot"] = arcAboveRobot;
  exports["drawImageData"] = drawImageData;
  exports["main"] = main;
  exports["foldrN"] = foldrN;
  exports["foldPixels"] = foldPixels;
