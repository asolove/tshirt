...
(function(exports) {
              ...
              return function (c) {
                  return function (u) {
                      return function (xs) {
                          var step = function (x) {
                              return function (_5) {
                                  if (Data_Array.length(_5.value0) === n - 1) {
                                      return new Data_Tuple.Tuple([  ], c(f(Data_Array.cons(x)(_5.value0)))(_5.value1));
                                  };
                                  if (Prelude.otherwise) {
                                      return new Data_Tuple.Tuple(Data_Array.cons(x)(_5.value0), _5.value1);
                                  };
                                  throw new Error("Failed pattern match at Main line 54, column 9 - line 55, column 9: " + [ x.constructor.name, _5.constructor.name ]);
                              };
                          };
  ...
  var countWhitePixels = function (pixels) {
      var isWhite = function (_4) {
          if (_4.length === 4) {
              var _11 = _4[0] + _4[1] + _4[2] > 254.0 * 3.0;
              if (_11) {
                  return 1;
              };
              if (!_11) {
              ...
              throw new Error("Failed pattern match at Main line 33, column 9 - line 35, column 1: " + [ _11.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main line 33, column 9 - line 35, column 1: " + [ _4.constructor.name ]);
      };
  ...
  var main = function __do() {
      ...
      var _1 = Graphics_Canvas.getContext2D(Data_Maybe_Unsafe.fromJust(_2))();
      var _0 = Graphics_Canvas_Free.runGraphics(_1)(Prelude.bind(Control_Monad_Free.bindFree(Data_Coyoneda.functorCoyoneda))(Graphics_Canvas_Free.setFillStyle("#999999"))(function () {
      ...
      Control_Monad_Eff_Console_Unsafe.logAny(lastPixel(Data_ArrayBuffer_Typed.toArray(_0.data)))();
      return Graphics_Canvas_Free.runGraphics(_1)(Graphics_Canvas_Free.putImageData(_0)(centerX)(0.0))();
  };
